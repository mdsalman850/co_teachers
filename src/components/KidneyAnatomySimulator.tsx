...
interface KidneyAnatomySimulatorProps {
  className?: string;
}

const KidneyAnatomySimulator: React.FC<KidneyAnatomySimulatorProps> = ({ className = '' }) => {
    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 py-3 px-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-lg font-bold text-white drop-shadow-sm">Human Kidney Anatomy Cross Section</h3>
            <p className="text-red-100 text-xs font-medium">Chapter 5 - Excretion</p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-700 leading-relaxed">
                <strong className="text-red-700">Human Kidney Anatomy Cross Section:</strong> The kidney is a vital organ that filters waste products and excess water from the blood to form urine. 
                This cross-sectional view reveals the internal structure of the kidney, including the renal cortex (outer region), renal medulla (inner region with pyramids), 
                renal pelvis (collecting area), and the extensive network of blood vessels (arteries and veins) that supply the kidney.
              </p>
              <p className="text-xs text-gray-600 mt-3 font-medium bg-white/60 rounded-md p-2 border border-red-200/50">
                <strong className="text-red-600">Instructions:</strong> Use your mouse to rotate, scroll to zoom, and explore the detailed internal anatomy of the human kidney.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="sketchfab-embed-wrapper" style={{ width: '100%', height: '100%', borderRadius: '0' }}>
          <iframe
            ...
            src="https://sketchfab.com/models/d8c0652ddff4474585ccba155c490622/embed"
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 via-black/40 to-transparent p-2">
          <p className="text-xs text-center text-white/90 font-medium">
            <a 
              href="https://sketchfab.com/3d-models/human-kidney-anatomy-cross-section-d8c0652ddff4474585ccba155c490622?utm_medium=embed&utm_campaign=share-popup&utm_content=d8c0652ddff4474585ccba155c490622" 
              target="_blank" 
              rel="nofollow" 
            ...
            {' by '}
            <a 
              href="https://sketchfab.com/zames1992?utm_medium=embed&utm_campaign=share-popup&utm_content=d8c0652ddff4474585ccba155c490622" 
              target="_blank" 
              rel="nofollow" 
              className="font-semibold text-red-300 hover:text-red-200 transition-colors hover:underline"
            >
            ...
            {' on '}
            <a 
              href="https://sketchfab.com?utm_medium=embed&utm_campaign=share-popup&utm_content=d8c0652ddff4474585ccba155c490622" 
              target="_blank" 
              rel="nofollow" 
              className="font-semibold text-red-300 hover:text-red-200 transition-colors hover:underline"
            >
...
export default KidneyAnatomySimulator;
