...
interface PhotosynthesisPlantAnatomySimulatorProps {
  className?: string;
}

const PhotosynthesisPlantAnatomySimulator: React.FC<PhotosynthesisPlantAnatomySimulatorProps> = ({ className = '' }) => {
    ...
    >
      ...
      <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 py-3 px-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-lg font-bold text-white drop-shadow-sm">Photosynthesis and Plant Anatomy</h3>
            <p className="text-green-100 text-xs font-medium">Chapter 7 - Transportation</p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-700 leading-relaxed">
                <strong className="text-green-700">Photosynthesis and Plant Anatomy:</strong> This 3D model demonstrates photosynthesis, the process by which plants use sunlight, water, and carbon dioxide to create oxygen and energy. 
                It also shows the structure of xylem and phloem vessels, which are responsible for transporting water, minerals, and nutrients throughout the plant. 
                The model illustrates key plant structures including roots, stems, leaves, and flowers, along with the vascular tissue system.
              </p>
              <p className="text-xs text-gray-600 mt-3 font-medium bg-white/60 rounded-md p-2 border border-green-200/50">
                <strong className="text-green-600">Instructions:</strong> Use your mouse to rotate, scroll to zoom, and explore the detailed structures of plant anatomy and the transportation system.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 via-black/40 to-transparent p-2">
          <p className="text-xs text-center text-white/90 font-medium">
            <a 
              href="https://sketchfab.com/3d-models/photosynthesis-and-plant-anatomy-5c426b7880e440ce834012d06763d502?utm_medium=embed&utm_campaign=share-popup&utm_content=5c426b7880e440ce834012d06763d502" 
              target="_blank" 
              rel="nofollow" 
            ...
            {' by '}
            <a 
              href="https://sketchfab.com/Deepak_Sharma?utm_medium=embed&utm_campaign=share-popup&utm_content=5c426b7880e440ce834012d06763d502" 
              target="_blank" 
              rel="nofollow" 
              className="font-semibold text-green-300 hover:text-green-200 transition-colors hover:underline"
            >
            ...
            {' on '}
            <a 
              href="https://sketchfab.com?utm_medium=embed&utm_campaign=share-popup&utm_content=5c426b7880e440ce834012d06763d502" 
              target="_blank" 
              rel="nofollow" 
              className="font-semibold text-green-300 hover:text-green-200 transition-colors hover:underline"
            >
...
export default PhotosynthesisPlantAnatomySimulator;
